...
=======
$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});var pContainerHeight=$(".bird-box").height();$(window).scroll(function(){var e=$(this).scrollTop();if(e<=pContainerHeight&&($(".logo").css({transform:"translate(0px, "+e/2+"%)"}),$(".back-bird").css({transform:"translate(0px, "+e/4+"%)"}),$(".fore-bird").css({transform:"translate(0px, -"+e/10+"%)"})),e>$(".tracks").offset().top-$(window).height()/1.2&&$(".tracks figure").each(function(e){setTimeout(function(){$(".tracks figure").eq(e).addClass("is-showing")},700*Math.exp(.14*e)-700)}),e>$(".large-window").offset().top-$(window).height()){$(".large-window").css({"background-position":"center "+(e-$(".large-window").offset().top)+"px"});var t=(e-$(".large-window").offset().top+400)/(e/5);$(".window-tint").css({opacity:t})}e>$(window).height()?$(".menu").slideDown():$(".menu").slideUp()}),$(document).ready(function(){var e=document.getElementById("spec");$(".my-content").hide(),$(".palka1,.palka2,.palka3,.palka4").hide(),$(".blur-menu").hide(),$(".bmenu-ober").hide(),$(".bmenu").hide(),$(".menu").hide(),$("#my-footer").hide(),$("footer").hide(),$(".right").hide(),$(".bgi1,.bgi2,.bgi3,.bgi4").hide(),$(".enter-site").click(function(){$("header").removeClass("site-header"),$(".site-header").removeClass("spectrum-cont"),e.parentNode.removeChild(e),$("header").addClass("main-site"),$(".spectrum").hide(),$(".enter-site").hide(),$(".left-text-1, .left-text-2").hide(),$(".palka1,.palka2,.palka3,.palka4").show(),$("#triangle-bottomleft, .bottom-text").hide(),$(".my-content").show(),$(".blur-menu").show(100),$(".bmenu-ober").show(0),$(".bmenu").show(1e3),$("#my-footer").show(),$(".right").show(),$("footer").show(),$(".bgi1,.bgi2,.bgi3,.bgi4").show(),$(".menu").slideUp()}),$(".resid").slick({slidesToShow:3,slidesToScroll:1,autoplay:!0,autoplaySpeed:3e3,prevArrow:!1,nextArrow:!1}),$(function(){$('a[data-target^="anchor"]').bind("click.smoothscroll",function(){var e=$(this).attr("href"),t=$(e).offset().top-50;return $("body, html").animate({scrollTop:t},500),!1})}),$("form").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"localhost:3000/mail.php",data:e.serialize()}).done(function(){alert("Thank you!"),setTimeout(function(){e.trigger("reset")},1e3)}),!1});var a=$("#canvas").get()[0].getContext("2d"),t=null;(t=document.createElement("audio")).src="audio/titov.mp3",t.controls=!0,t.crossOrigin="anonymous";var o=new AudioContext,n=o.createScriptProcessor(512,1,1),i=o.createAnalyser();i.smoothingTimeConstant=.7;var r=i.fftSize=32,s=o.createMediaElementSource(t);function c(e,t,o,n,i,a,r,s){void 0===s&&(s=!0),void 0===a&&(a=5),e.beginPath(),e.moveTo(t+a,o),e.lineTo(t+n-a,o),e.quadraticCurveTo(t+n,o,t+n,o+a),e.lineTo(t+n,o+i-a),e.quadraticCurveTo(t+n,o+i,t+n-a,o+i),e.lineTo(t+a,o+i),e.quadraticCurveTo(t,o+i,t,o+i-a),e.lineTo(t,o+a),e.quadraticCurveTo(t,o,t+a,o),e.closePath(),s&&e.stroke(),r&&e.fill()}t.addEventListener("canplay",function(){s.connect(i),i.connect(n),n.connect(o.destination),s.connect(o.destination)}),window.onload=function(){t.play()},document.querySelector("button").addEventListener("click",function(){o.resume()}),t.addEventListener("ended",function(){t.play()},!1),n.onaudioprocess=function(){var e=new Uint8Array(i.frequencyBinCount);i.getByteFrequencyData(e),a.clearRect(0,0,1920,255),a.fillStyle="rgba(255,255,255,1)",function(e){for(var t=2;t<e.length;t+=3)for(var o=e[t],n=parseInt((o+1)/r),i=8;8-n<i;i--)a.fillStyle="rgba(255,255,255,1)",c(a,(t-2)/3*23+0,18*i,18,13,3,!0,!1)}(e)}});
>>>>>>> f5505b0b8893600de5a09fcfb0856aeacb184549
